     ...
     // int randomNumber = random.nextInt(4987536); // from 0 upto 99 included
      ...
      if (status.isGranted) {
        ...
        AwesomeDialog(
          ...
          title: 'Video Is Downloaded',

          desc: 'File is downloaded in Galary and  +$result',
          btnOkOnPress: () {},
        )..show();
      } else {
    ...
    getData() async {
      ...
      if (graphql != null) {
        ...
        AwesomeDialog(
          ...
          desc: 'This Video Link Is Private ,Try with a public post instead',
